...
public class Quiz extends Meeting {

	public Quiz(String type, String section, String room, String meetingDay, String meetingTime,
	...
	public String toString(){
		String msg = "Quiz Meeting Information\n";
		if (getSection() != ""){
