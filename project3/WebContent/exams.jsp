...
<table>
	<tbody>
		<tr>
			...
			<td width="180" id="leftTd" valign="top" align="right">
				<a href= "http://www.usc.edu">
 						<img id="uscImage" src=<%=school.getImage() %> border="0">
 					</a>
 					<br>
 					<br>
 					<font class="hover" size="+1">
 						<a href="http://cs.usc.edu"><%=department.getPrefix()+" Department"%></a>
 					</font>
 					<br>
 					<br>
 					<font class="hover" size="+1"><a href="http://localhost:8080/tomcatTest1/test.jsp"><%=department.getPrefix()+" "+course.getNumber()+ " Home" %></a></font>
 					<br>
 					<br>
 					<font class="hover" size="+1"><a href=<%=course.getSyllabus() %>>Syllabus</a></font>
 					<br>
 					<br>
 					<font class="hover" size="+1"><a href="lectures.jsp">Lectures</a></font>
 					<br>
 					<br>
 					<font class="hover" size="+1"><a href="assignments.jsp">Assignments</font>
 					<br>
 					<br>
 					<font class="hover" size="+1">Previous Exams</font>
 					<br>
 					<br>
