...
<table>
	<tbody>
		<tr>
			...
			<td width="240" id="leftTd" valign="top" align="middle">
				<a href= "http://www.usc.edu">
 					...
 					<br>
 					<br>
 					<font class="hover" size="+1"><a href="test.jsp"><%=department.getPrefix()+" "+course.getNumber()+ " Home" %></a></font>
 					<br>
 					<br>
 					...
 					<br>
 					<br>
 					<font class="hover" size="+1"><a href="assignments.jsp">Assignments</a></font>
 					<br>
 					<br>
 					<font class="hover" size="+1"><a>Previous Exams</a></font>
 					<br>
 					<br>
 					</div>
